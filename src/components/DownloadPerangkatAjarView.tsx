      ...
      <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 text-white rounded-2xl p-6 md:p-8 shadow-xl border border-purple-800">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-slate-200 text-sm md:text-base leading-relaxed">
            Unduh berkas Perangkat Ajar Deep Learning Kurikulum Merdeka terlengkap untuk semua jenjang dan mata pelajaran melalui portal resmi Cecep Jamaludin di bawah ini.
          </p>
